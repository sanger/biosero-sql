...
((SELECT id FROM `automation_systems` WHERE automation_system_name = 'CPA'), 'control_excluded_destination_wells', 'D3, H10', 'list of wells to exclude from control placement on the destination', now(), now()),
...
((SELECT id FROM `automation_systems` WHERE automation_system_name = 'CPB'), 'control_excluded_destination_wells', 'D3, H10', 'list of wells to exclude from control placement on the destination', now(), now()),
